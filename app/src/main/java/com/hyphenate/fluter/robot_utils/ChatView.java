...
public class ChatView extends RelativeLayout {
    ...
    public void refreshLocation() {
        this.x = application.chatViewX;
        this.y = application.chatViewY;
        this.mTouchStartX = application.mTouchStartX;
        this.mTouchStartY = application.mTouchStartY;
        updateViewPosition();
    }


    public ChatView(Activity activity, int backgroundRes) {
        super(activity);
//        LayoutInflater.from(activity).inflate(R.layout.view_chat, this);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        x = event.getRawX();
        y = event.getRawY();
        application.chatViewX = x;
        application.chatViewY = y;
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                application.mTouchStartX = mTouchStartX;
                application.mTouchStartY = mTouchStartY;
