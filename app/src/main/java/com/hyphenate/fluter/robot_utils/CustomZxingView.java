...
public class CustomZxingView extends ViewfinderView {
    ...
    public int[] colors = new int[]{0xff69CFFF, 0xff69CFFF, 0xff69CFFF};
    ...
    public void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#59C8FF"));//定义画笔的颜色
...
//
        ...
        //绘制四条线
        paint.setColor(Color.parseColor("#59C8FF"));
        ...
        if (resultBitmap != null) {
            ...
            if (laserLinePosition + 15 > frame.height()) {
                laserLinePosition = 0;
            }
...
//            Bitmap bitmapLine = BitmapFactory.decodeResource(getResources(), R.mipmap.scan_line);
