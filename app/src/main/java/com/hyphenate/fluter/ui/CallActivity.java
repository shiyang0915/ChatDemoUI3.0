...
public class CallActivity extends BaseActivity {
    ...
    protected final int MSG_CALL_REMOTE = 7;
    ...
    protected Handler handler = new Handler(callHandlerThread.getLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_CALL_REMOTE:
                case MSG_CALL_MAKE_VIDEO:
                case MSG_CALL_MAKE_VOICE:
                    try {
                        if (msg.what == MSG_CALL_REMOTE) {
                            EMClient.getInstance().callManager().makeVideoCall(username, "remote");
                        } else if (msg.what == MSG_CALL_MAKE_VIDEO) {
