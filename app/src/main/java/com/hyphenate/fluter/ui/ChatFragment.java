...
import com.hyphenate.fluter.domain.EmojiconExampleGroupData;
import com.hyphenate.fluter.domain.RobotUser;
import com.hyphenate.fluter.widget.ChatRowConferenceInvitePresenter;
import com.hyphenate.fluter.widget.ChatRowLivePresenter;
import com.hyphenate.fluter.widget.EaseChatRecallPresenter;
import com.hyphenate.fluter.widget.EaseChatVoiceCallPresenter;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    private static final int ITEM_MONITORING = 17;
...
//                                putExtra("groupId", toChatUsername), REQUEST_CODE_SELECT_AT_USER);
    ...
    protected void registerExtendMenuItem() {
        ...
        inputMenu.registerExtendMenuItem("语音通话", R.mipmap.input_voice_call, ITEM_VOICE_CALL, extendMenuItemClickListener);
        inputMenu.registerExtendMenuItem("视频通话", R.mipmap.input_video_call, ITEM_VIDEO_CALL, extendMenuItemClickListener);
        inputMenu.registerExtendMenuItem("远程监控", R.drawable.em_chat_monitring, ITEM_MONITORING, extendMenuItemClickListener);
...
//                LiveActivity.startLive(getContext(), toChatUsername);
     ...
     * make a remote call
     */
    protected void startRemoteCall() {
