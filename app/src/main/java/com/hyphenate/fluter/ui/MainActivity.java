...
import com.hyphenate.fluter.runtimepermissions.PermissionsResultAction;
...
//    private SettingsFragment settingFragment;
    ...
    @InjectView(R.id.tab_relative_msg)
    RelativeLayout relativeTabMsg;

//    @InjectView(R.id.image_tab_msg)
//    ImageView imageTabMsg;
//
//    @InjectView(R.id.tv_tab_msg)
//    TextView textTabMsg;


    @InjectView(R.id.tab_relative_contact)
    RelativeLayout relativeTabContact;

//    @InjectView(R.id.image_tab_contact)
//    ImageView imageTabContact;
//
//    @InjectView(R.id.tv_tab_contact)
//    TextView textTabContact;


    @InjectView(R.id.tab_relative_personal)
    RelativeLayout relativeTabPersonal;

//    @InjectView(R.id.image_tab_personal)
//    ImageView imageTabPersonal;
//
//    @InjectView(R.id.tv_tab_personal)
//    TextView textTabPersonal;
...
//            settingFragment = (SettingsFragment) getSupportFragmentManager().getFragment(savedInstanceState, SettingsFragment.class.getSimpleName());
            personalCenterFragment = (PersonalCenterFragment) getSupportFragmentManager().getFragment(savedInstanceState, PersonalCenterFragment.class.getSimpleName());
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, conversationListFragment)
                    ...
                    .add(R.id.fragment_container, personalCenterFragment).hide(personalCenterFragment)
                    .show(conversationListFragment)
                    .commit();
        }
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        mTabs[0] = findViewById(R.id.tab_relative_msg);
        mTabs[1] = findViewById(R.id.tab_relative_contact);
        mTabs[2] = findViewById(R.id.tab_relative_personal);
        // select first tab
    ...
    public void onTabClicked(View view) {
        switch (view.getId()) {
            case R.id.tab_relative_msg:
                index = 0;
                break;
            case R.id.tab_relative_contact:
                index = 1;
                break;
            case R.id.tab_relative_personal:
                index = 2;
                break;
        }
...
//                        contactListFragment.refresh();
    ...
    protected void onDestroy() {
        super.onDestroy();
        DemoApplication.getInstance().activityList.clear();
    ...
    public void updateUnreadLabel() {
        ...
        if (count > 0) {
            ...
            Log.i("shiyang_tag", "updateUnreadLabel");
        } else {
...
//                    conversationListFragment.textNewPriendCount.setVisibility(View.VISIBLE);
//                    conversationListFragment.textNewPriendCount.setText(count + "");
                    contactListFragment.textNewFriendsNum.setVisibility(View.VISIBLE);
                    contactListFragment.textNewFriendsNum.setText(count + "");
                } else {
                    unreadAddressLable.setVisibility(View.INVISIBLE);
                    contactListFragment.textNewFriendsNum.setVisibility(View.INVISIBLE);
                }
            }
        });
    }
