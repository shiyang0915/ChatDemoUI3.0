...
public class RemoteActivity extends CallActivity implements OnClickListener {
    ...
    public static class BrightnessDataProcess implements EMCameraDataProcessor {
        byte yDelta = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.em_activity_remote_call);

        DemoHelper.getInstance().isRemoteCalling = true;
        callType = 1;
...
//        recordBtn = (Button) findViewById(R.id.btn_record_video);
        ...
        Button advanceBtn = (Button) findViewById(R.id.btn_go_on);
        Button retreatBtn = (Button) findViewById(R.id.btn_go_back);
        Button leftBtn = (Button) findViewById(R.id.btn_go_left);
        Button rightBtn = (Button) findViewById(R.id.btn_go_right);
        Button stopBtn = (Button) findViewById(R.id.btn_go_stop);
...
//        recordBtn.setOnClickListener(this);
        ...
        Log.i("SHIYANGSHIYANGSHIYANG", username + "   -----   " + isInComingCall);
        ...
        if (!isInComingCall) {// outgoing call
            ...
            handler.sendEmptyMessage(MSG_CALL_REMOTE);
...
//                            recordBtn.setVisibility(View.VISIBLE);
                                ...
                                PhoneStateManager.get(RemoteActivity.this).addStateCallback(phoneStateCallback);
                                //关闭免提
                                ...
                                isMuteState = true;
                                Log.e("remoteActivity", "电话接听");
                                EMMessage cmdMsg7 = EMMessage.createSendMessage(EMMessage.Type.CMD);
                                String action7 = "CLOSEAIUI";
                                EMCmdMessageBody cmdBody7 = new EMCmdMessageBody(action7);
                                cmdMsg7.setTo(username);
                                cmdMsg7.addBody(cmdBody7);
                                EMClient.getInstance().chatManager().sendMessage(cmdMsg7);
                            ...
                            private void postDelayedCloseMsg() {
                                uiHandler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        PhoneStateManager.get(RemoteActivity.this).removeStateCallback(phoneStateCallback);
...
//                                        callStateTextView.setText(s6);
                                        ...
                                        if (isInComingCall) {
                                            ...
                                            if (callingState != CallingState.NORMAL) {
                                                ...
                                                Log.e("remoteActivity", "电话挂断");
                                                EMMessage cmdMsg8 = EMMessage.createSendMessage(EMMessage.Type.CMD);
                                                String action8 = "OPENAIUI";
                                                EMCmdMessageBody cmdBody8 = new EMCmdMessageBody(action8);
                                                cmdMsg8.setTo(username);
                                                cmdMsg8.addBody(cmdBody8);
                                                EMClient.getInstance().chatManager().sendMessage(cmdMsg8);
                                            } else {
                                                callStateTextView.setText(s6);
                                            }
                                        }
                                ...
                                Toast.makeText(RemoteActivity.this, callStateTextView.getText(), Toast.LENGTH_SHORT).show();
                                postDelayedCloseMsg();
                            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_hangup_call: // hangup
                ...
                EMMessage cmdMsg5 = EMMessage.createSendMessage(EMMessage.Type.CMD);
                String action5 = "STOPSERVICE";
                EMCmdMessageBody cmdBody5 = new EMCmdMessageBody(action5);
                cmdMsg5.setTo(username);
                cmdMsg5.addBody(cmdBody5);
                EMClient.getInstance().chatManager().sendMessage(cmdMsg5);
                break;
        ...
        */
            ...
            case R.id.btn_capture_image:
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(RemoteActivity.this, "saved image to:" + filename, Toast.LENGTH_SHORT).show();
                    }
                });
                break;
            case R.id.btn_go_on:
            ...
            case R.id.btn_go_left:
                ...
                String action2 = "GOLEFT";
                EMCmdMessageBody cmdBody2 = new EMCmdMessageBody(action2);
                cmdMsg2.setTo(username);
                cmdMsg2.addBody(cmdBody2);
                EMClient.getInstance().chatManager().sendMessage(cmdMsg2);
                break;
            case R.id.btn_go_right:
                EMMessage cmdMsg3 = EMMessage.createSendMessage(EMMessage.Type.CMD);
                String action3 = "GORIGHT";
                EMCmdMessageBody cmdBody3 = new EMCmdMessageBody(action3);
                cmdMsg3.setTo(username);
                cmdMsg3.addBody(cmdBody3);
                EMClient.getInstance().chatManager().sendMessage(cmdMsg3);
                break;
            case R.id.btn_go_stop:
                EMMessage cmdMsg4 = EMMessage.createSendMessage(EMMessage.Type.CMD);
                String action4 = "GOSTOP";
                EMCmdMessageBody cmdBody4 = new EMCmdMessageBody(action4);
                cmdMsg4.setTo(username);
                cmdMsg4.addBody(cmdBody4);
                EMClient.getInstance().chatManager().sendMessage(cmdMsg4);
                break;
            default:
                break;
        }
