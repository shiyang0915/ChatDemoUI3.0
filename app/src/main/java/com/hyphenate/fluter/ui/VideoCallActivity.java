...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    private LinearLayout linearConnectingHeadView;
    ...
    private ImageView imageQieHuanCamera;
    private ImageView imageHoldOn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //新添加
        imageScan = findViewById(R.id.image_shouqi_video);
        imageCloseCamera = findViewById(R.id.image_close_camera);
        imageQieHuanCamera = findViewById(R.id.image_qiehuan_camera);
        imageHoldOn = findViewById(R.id.image_hold_on);
...
//        topContainer = (LinearLayout) findViewById(R.id.ll_top_container);
        ...
        linearConnectingHeadView = findViewById(R.id.linear_conneceting_head);
...
//        YDeltaSeekBar.setOnSeekBarChangeListener(new YDeltaSeekBarListener());
        ...
        imageCloseCamera.setOnClickListener(this);
        imageQieHuanCamera.setOnClickListener(this);
        imageHoldOn.setOnClickListener(this);
        ...
        if (!isInComingCall) {// outgoing call   去电（主动发起）
...
//            String st = getResources().getString(R.string.Are_connected_to_each_other);
            ...
            callStateTextView.setText("邀请你接受视频通话");
...
//                                    ? R.string.direct_call : R.string.relay_call);
                                ...
                                comingBtnContainer.setVisibility(View.INVISIBLE);
                                linearConnectingHeadView.setVisibility(View.INVISIBLE);
...
//                                Toast.makeText(VideoCallActivity.this, callStateTextView.getText(), Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.image_shouqi_video:

                break;

            case R.id.image_close_camera:

                break;

            case R.id.image_qiehuan_camera:
                handler.sendEmptyMessage(MSG_CALL_SWITCH_CAMERA);
                break;

            case R.id.image_hold_on:
                isRefused = true;
